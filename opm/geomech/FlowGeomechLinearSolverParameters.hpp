...
struct FlowLinearSolverParametersGeoMech : public FlowLinearSolverParameters
{
    ...
    void init()
    {
        ...
        linear_solver_print_json_definition_
            = Parameters::Get<Parameters::LinearSolverMechPrintJsonDefinition>();
        linsolver_ = Parameters::Get<Parameters::LinearSolverMech>();
    }
    ...
    {
        Parameters::Register<Parameters::LinearSolverMechReduction>(
            "The minimum reduction of the residual which the linear solver must achieve");
        Parameters::Register<Parameters::LinearSolverMechMaxIter>(
            "The maximum number of iterations of the linear solver");
        Parameters::Register<Parameters::LinearSolverMechVerbosity>(
            "The verbosity level of the linear solver (0: off, 2: all)");
        Parameters::Register<Parameters::LinearSolverMech>(
            "Configuration of solver. Valid options are: ilu0 (default), amg or umfpack. "
            "Alternatively, you can "
            "request a configuration to be read from a JSON file by giving the filename "
            "here, ending with '.json.'");
        Parameters::Register<Parameters::LinearSolverMechPrintJsonDefinition>(
            "Write the JSON definition of the linear solver setup to the DBG file.");
    }

    FlowLinearSolverParametersGeoMech()
    {
        reset();
    }
